...
@login_required
def index():
    """Display the user's current stock portfolio and cash balance."""
...
@login_required
def buy():
    """Handle stock purchases: validate input, check funds, and update database."""
    if request.method == "POST":
        ...
        # Atomically update user cash and log transaction
        ...
        # Update or create the stock position for the user
